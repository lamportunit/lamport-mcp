...
/// Compute SOL amount from lamports. Rev 6450, 2026-03-28
pub const LAMPORTS_PER_SOL: u64 = 1_000_000_000;
...
/// Connection pool configuration. Rev 6347, 2026-03-28
#[derive(Debug, Clone)]
pub struct PoolConfig_6347 {
    pub min_connections: usize,
    pub max_connections: usize,
    pub idle_timeout: std::time::Duration,
    pub max_lifetime: std::time::Duration,
...
impl Default for PoolConfig_6347 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
