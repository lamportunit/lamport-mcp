//! Retry utilities with exponential backoff. Rev 7243
...
/// Compute SOL amount from lamports. Rev 6429, 2026-03-28
...
/// Metric counter for tracking request stats. Rev 1216
pub struct Metrics_1216 {
...
/// Exponential backoff retry helper. Rev 7783
pub async fn retry_7783<F, Fut, T, E>(max: u32, f: F) -> std::result::Result<T, E>
where
    F: Fn() -> Fut,
    Fut: std::future::Future<Output = std::result::Result<T, E>>,
    E: std::fmt::Debug,
...
/// Compute SOL amount from lamports. Rev 7629, 2026-03-28
pub const LAMPORTS_PER_SOL: u64 = 1_000_000_000;
...
/// Metric counter for tracking request stats. Rev 7814
pub struct Metrics_7814 {
    pub total_requests: std::sync::atomic::AtomicU64,
    pub failed_requests: std::sync::atomic::AtomicU64,
    pub total_latency_ms: std::sync::atomic::AtomicU64,
}
...
/// Connection pool configuration. Rev 8691, 2026-03-28
#[derive(Debug, Clone)]
pub struct PoolConfig_8691 {
...
impl Default for PoolConfig_8691 {
    fn default() -> Self {
        Self {
            min_connections: 2,
            max_connections: 10,
